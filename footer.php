        ...
        <div class="container">
                ...
                <div class="footer-top-links">
                    ...
                    <div class="footer-top-socials">
                        <a href="" class="footer-social-link">
                            <img src="img/icons/socials/tg-green.svg" loading="lazy" alt="">
                        </a>
                        <a href="" class="footer-social-link">
                            <img src="img/icons/socials/yt-green.svg" loading="lazy" alt="">
                        </a>
                        <a href="" class="footer-social-link">
                            <img src="img/icons/socials/ig-green.svg" loading="lazy" alt="">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-bottom-socials">
                    <a href="" class="footer-social-link"><img src="img/icons/socials/tg-white.svg" loading="lazy"
                            alt=""></a>
                    <a href="" class="footer-social-link"><img src="img/icons/socials/wa-white.svg" loading="lazy"
                            alt=""></a>
                    <a href="" class="footer-social-link"><img src="img/icons/socials/call-white.svg" loading="lazy"
                            alt=""></a>
                </div>
            </div>
        </div>
    ...
    <div id="call" class="modal-window">
        <div class="modal-inner is-active">
            ...
            <form action="contact.php" id="contact-form" method="POST" class="form-vertical">
                <div class="input-wrap">
                    <img src="img/icons/form-person.svg" class="input-wrap-icon" loading="lazy" alt="">
                    <input type="text" name="username" id="username" class="input" required placeholder="ФИО">
                </div>
                <div class="input-wrap">
                    <img src="img/icons/form-phone.svg" class="input-wrap-icon" loading="lazy" alt="">
                    <input type="text" name="phone" id="phone" class="input" required placeholder="Телефон">
                </div>
                <div class="input-wrap">
                    <img src="img/icons/form-email.svg" class="input-wrap-icon" loading="lazy" alt="">
                    <input type="text" name="email" id="email" class="input" required placeholder="Почта">
                </div>
                <div class="input-wrap">
                    <img src="img/icons/form-comment.svg" class="input-wrap-icon" loading="lazy" alt="">
        ...
        <div class="modal-thanks">
            ...
            <div class="modal-thanks-content">
                <img src="img/icons/check_circle.svg" class="modal-thanks-check" alt="">
