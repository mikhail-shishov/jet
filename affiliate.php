<?php
$meta_title = 'Вступайте в нашу партнерскую программу';
$meta_description = '...';
?>
...
<section class="affiliate-intro-sect">
    <div class="container">
        ...
        <img src="img/illustrations/affiliate-section-image.png" class="intro-img" alt="">
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="step-grid step-grid-2">
            ...
            <div class="step-item">
                ...
                <p>Предлагайте услуги Лидер.Джет вашим друзьям, партнерам и клиентам.</p>
            </div>
            <div class="step-item">
