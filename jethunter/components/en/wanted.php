<section class="regular-sect">
    <div class="container">
        <div class="center">
            <h2 class="h2">We are looking for</h2>
        </div>

        <?php $planes_data = carbon_get_theme_option(get_the_ID(), 'wanted_short_en');
            ...
            <div class="looking-grid looking-grid-full">
                ...
                ?>
                    <div class="<?php echo $item_class; ?>">
                        ...
                        <button type="button" class="btn js-modal" data-modal="#call" data-title="<?php echo esc_attr($plane['title']); ?>">Book</button>
                    </div>
                <?php endforeach; ?>
            </div>
        <?php endif; ?>
