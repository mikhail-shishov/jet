...
<section class="fleet-sect">
    <div class="container">
        ...
        <form class="search-form" action="/ru/our-fleet/" method="POST">
...
<section class="regular-sect">
    <div class="container">
        ...
        <div class="btn-container btn-container-wrap">
            <a href="/rent" class="btn">Аренда малых самолетов</a>
            <a href="/rent" class="btn">Аренда дальнемагистральных самолетов </a>
            <a href="/rent" class="btn">Аренда средних самолетов</a>
            <a href="/rent" class="btn">Аренда больших самолетов</a>
            <a href="/rent" class="btn">Аренда турбовинтовых самолетов</a>
            <a href="/rent" class="btn">Аренда очень легких самолетов </a>
        </div>
    </div>
</section>
